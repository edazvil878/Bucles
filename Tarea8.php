<!-- Crear un formulario que tenga un campo de texto. En el irán codificados los menús superiores e inferiores de la web. Dependiendo de los valores,
    en la página destino aparecerá un menú superior y otro inferior con dichas opciones. El menú deberá tener una apariencia aceptable con estilo bootstrap última versión.
